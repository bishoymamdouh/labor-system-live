...
content = content.replace(
    '<button type="button" id="print-report-btn" class="btn btn-secondary"><i class="fas fa-print"></i> طباعة</button>',
...
content = content.replace('// --- Core Initialization ---', scriptToAdd + '\n    // --- Core Initialization ---');

fs.writeFileSync("index.html", content);
console.log("Success! Added printWorkerReceipts logic.");
